...
- 抓取时间：2026-09-14（2026 更新批次，官方页面更新于 2026-07-21 08:21:55）
...
短视频沉浸是一种通过全屏展示、弱化界面干扰，让用户专注于视频内容的呈现模式。针对主流的9:16比例视频进行处理，结合屏幕比例尺寸、系统控件布局、视频裁剪等技术，以增强视觉沉浸感。开发者可参考 adaptive\_video 使用说明进行适配与快速上手，短视频浏览区域将综合考虑页面窗口尺寸、视频比例、Tab导航栏高度等信息，根据沉浸规则计算沉浸式布局方案。


以下是adaptive\_video 使用的自适应沉浸布局计算规则
