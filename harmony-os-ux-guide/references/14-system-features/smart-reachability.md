...
- 抓取时间：2026-09-14（2026 新增补抓，官方页面更新于 2026-06-12 16:59）
...
组件出场位移动画使用曲线 interpolatingSpring (velocity 0；mass 1；stiffness 200；damping 17)。

从屏幕外移出或移入的组件，动画使用曲线 interpolatingSpring (velocity 0；mass 1；stiffness 170；damping 17)。
